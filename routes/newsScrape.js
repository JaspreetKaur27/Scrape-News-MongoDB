...
module.exports = (router, db) => {
    ...
    router.get("/scraped", (req, res) => {
        var link = "https://www.cp24.com/news";
        request(link, (err, response, html) => {
            ...
            $("li.dc").each((i, el) => {
                ...
                content.imgURL = $(element).children('div.element').children('div.teaser-image-wrapper').children('div.teaserImage').children('a').children('img').attr('src');
